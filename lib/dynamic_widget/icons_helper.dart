...
// Kinda self explanatory, no?
IconData getEvaIcon({String name}) {
  return EvaIconsMap[name];
}
...
const Map<String, IconData> EvaIconsMap = <String, IconData>{
  'wifi': EvaIcons.wifi,
  'volumeUp': EvaIcons.volumeUp,
  'wifiOff': EvaIcons.wifiOff,
  'volumeOff': EvaIcons.volumeOff,
  'volumeMute': EvaIcons.volumeMute,
  'volumeDown': EvaIcons.volumeDown,
  'video': EvaIcons.video,
  'videoOff': EvaIcons.videoOff,
  'upload': EvaIcons.upload,
  'undo': EvaIcons.undo,
  'unlock': EvaIcons.unlock,
  'umbrella': EvaIcons.umbrella,
  'twitter': EvaIcons.twitter,
  'trendingDown': EvaIcons.trendingDown,
  'trendingUp': EvaIcons.trendingUp,
  'tv': EvaIcons.tv,
  'trash': EvaIcons.trash,
  'trash2': EvaIcons.trash2,
  'toggleRight': EvaIcons.toggleRight,
  'toggleLeft': EvaIcons.toggleLeft,
  'thermometer': EvaIcons.thermometer,
  'thermometerPlus': EvaIcons.thermometerPlus,
  'thermometerMinus': EvaIcons.thermometerMinus,
  'text': EvaIcons.text,
  'sync': EvaIcons.sync,
  'swap': EvaIcons.swap,
  'stopCircle': EvaIcons.stopCircle,
  'sun': EvaIcons.sun,
  'star': EvaIcons.star,
  ...
  'skipBack': EvaIcons.skipBack,
  'skipForward': EvaIcons.skipForward,
  'shuffle': EvaIcons.shuffle,
  'shuffle2': EvaIcons.shuffle2,
  'shoppingCart': EvaIcons.shoppingCart,
  'shoppingBag': EvaIcons.shoppingBag,
  'shield': EvaIcons.shield,
  'shieldOff': EvaIcons.shieldOff,
  'shake': EvaIcons.shake,
  'share': EvaIcons.share,
  'settings': EvaIcons.settings,
  'settings2': EvaIcons.settings2,
  'scissors': EvaIcons.scissors,
  'search': EvaIcons.search,
  'save': EvaIcons.save,
  'rewindRight': EvaIcons.rewindRight,
  'repeat': EvaIcons.repeat,
  'refresh': EvaIcons.refresh,
  'rewindLeft': EvaIcons.rewindLeft,
  'recording': EvaIcons.recording,
  'radioButtonOn': EvaIcons.radioButtonOn,
  'radioButtonOff': EvaIcons.radioButtonOff,
  'radio': EvaIcons.radio,
  'questionMark': EvaIcons.questionMark,
  'questionMarkCircle': EvaIcons.questionMarkCircle,
  'printer': EvaIcons.printer,
  'pricetags': EvaIcons.pricetags,
  'power': EvaIcons.power,
  'plus': EvaIcons.plus,
  'plusSquare': EvaIcons.plusSquare,
  'plusCircle': EvaIcons.plusCircle,
  'playCircle': EvaIcons.playCircle,
  'pin': EvaIcons.pin,
  'pieChart': EvaIcons.pieChart,
  'pieChart2': EvaIcons.pieChart2,
  'phone': EvaIcons.phone,
  'phoneMissed': EvaIcons.phoneMissed,
  'phoneOff': EvaIcons.phoneOff,
  'phoneCall': EvaIcons.phoneCall,
  'person': EvaIcons.person,
  'personRemove': EvaIcons.personRemove,
  'personDelete': EvaIcons.personDelete,
  'personDone': EvaIcons.personDone,
  'personAdd': EvaIcons.personAdd,
  'percent': EvaIcons.percent,
  'people': EvaIcons.people,
  'pauseCircle': EvaIcons.pauseCircle,
  'paperPlane': EvaIcons.paperPlane,
  'options': EvaIcons.options,
  'pantone': EvaIcons.pantone,
  'npm': EvaIcons.npm,
  'options2': EvaIcons.options2,
  'navigation': EvaIcons.navigation,
  'navigation2': EvaIcons.navigation2,
  'music': EvaIcons.music,
  'move': EvaIcons.move,
  'moreVertical': EvaIcons.moreVertical,
  'moreHorizotnal': EvaIcons.moreHorizotnal,
  'moon': EvaIcons.moon,
  'monitor': EvaIcons.monitor,
  'minus': EvaIcons.minus,
  'minusSquare': EvaIcons.minusSquare,
  'minimize': EvaIcons.minimize,
  'minusCircle': EvaIcons.minusCircle,
  'mic': EvaIcons.mic,
  'micOff': EvaIcons.micOff,
  'messageSquare': EvaIcons.messageSquare,
  'messageCircle': EvaIcons.messageCircle,
  'menu': EvaIcons.menu,
  'menuArrow': EvaIcons.menuArrow,
  'menu2': EvaIcons.menu2,
  'maximize': EvaIcons.maximize,
  'map': EvaIcons.map,
  'logOut': EvaIcons.logOut,
  'logIn': EvaIcons.logIn,
  'lock': EvaIcons.lock,
  'list': EvaIcons.list,
  'linkedin': EvaIcons.linkedin,
  'link': EvaIcons.link,
  'link2': EvaIcons.link2,
  ...
  'image2': EvaIcons.image2,
  'home': EvaIcons.home,
  'heart': EvaIcons.heart,
  'headphones': EvaIcons.headphones,
  'hash': EvaIcons.hash,
  'hardDrive': EvaIcons.hardDrive,
  'grid': EvaIcons.grid,
  'google': EvaIcons.google,
  'globe': EvaIcons.globe,
  'globe3': EvaIcons.globe3,
  'globe2': EvaIcons.globe2,
  'github': EvaIcons.github,
  'gift': EvaIcons.gift,
  'folder': EvaIcons.folder,
  'funnel': EvaIcons.funnel,
  'folderRemove': EvaIcons.folderRemove,
  'folderAdd': EvaIcons.folderAdd,
  'flip': EvaIcons.flip,
  'flip2': EvaIcons.flip2,
  'flash': EvaIcons.flash,
  'flashOff': EvaIcons.flashOff,
  'flag': EvaIcons.flag,
  'film': EvaIcons.film,
  'file': EvaIcons.file,
  'fileRemove': EvaIcons.fileRemove,
  'fileText': EvaIcons.fileText,
  'fileAdd': EvaIcons.fileAdd,
  'facebook': EvaIcons.facebook,
  'eye': EvaIcons.eye,
  'eyeOff': EvaIcons.eyeOff,
  'eyeOff2': EvaIcons.eyeOff2,
  'externalLink': EvaIcons.externalLink,
  'expand': EvaIcons.expand,
  'email': EvaIcons.email,
  'edit': EvaIcons.edit,
  'edit2': EvaIcons.edit2,
  'droplet': EvaIcons.droplet,
  'download': EvaIcons.download,
  'dropletOff': EvaIcons.dropletOff,
  'doneAll': EvaIcons.doneAll,
  'diagonalArrowRightUp': EvaIcons.diagonalArrowRightUp,
  'diagonalArrowRightDown': EvaIcons.diagonalArrowRightDown,
  'diagonalArrowLeftUp': EvaIcons.diagonalArrowLeftUp,
  'diagonalArrowLeftDown': EvaIcons.diagonalArrowLeftDown,
  'cube': EvaIcons.cube,
  'crop': EvaIcons.crop,
  'creditCard': EvaIcons.creditCard,
  'cornerUpRight': EvaIcons.cornerUpRight,
  'cornerUpLeft': EvaIcons.cornerUpLeft,
  'cornerRightUp': EvaIcons.cornerRightUp,
  'cornerRightDown': EvaIcons.cornerRightDown,
  'cornerLeftUp': EvaIcons.cornerLeftUp,
  'cornerDownLeft': EvaIcons.cornerDownLeft,
  'cornerLeftDown': EvaIcons.cornerLeftDown,
  'cornerDownRight': EvaIcons.cornerDownRight,
  'copy': EvaIcons.copy,
  'compass': EvaIcons.compass,
  'colorPicker': EvaIcons.colorPicker,
  'colorPalette': EvaIcons.colorPalette,
  'collapse': EvaIcons.collapse,
  'code': EvaIcons.code,
  'codeDownload': EvaIcons.codeDownload,
  'cloudUpload': EvaIcons.cloudUpload,
  'cloudDownload': EvaIcons.cloudDownload,
  'closeSquare': EvaIcons.closeSquare,
  'close': EvaIcons.close,
  'closeCircle': EvaIcons.closeCircle,
  'clock': EvaIcons.clock,
  'chevronUp': EvaIcons.chevronUp,
  'clipboard': EvaIcons.clipboard,
  'chevronRight': EvaIcons.chevronRight,
  'chevronLeft': EvaIcons.chevronLeft,
  'checkmark': EvaIcons.checkmark,
  'chevronDown': EvaIcons.chevronDown,
  'checkmarkSquare': EvaIcons.checkmarkSquare,
  'checkmarkSquare2': EvaIcons.checkmarkSquare2,
  'checkmarkCircle': EvaIcons.checkmarkCircle,
  'charging': EvaIcons.charging,
  'checkmarkCircle2': EvaIcons.checkmarkCircle2,
  'cast': EvaIcons.cast,
  'car': EvaIcons.car,
  ...
  'bookOpen': EvaIcons.bookOpen,
  'book': EvaIcons.book,
  'bluetooth': EvaIcons.bluetooth,
  'bell': EvaIcons.bell,
  'behance': EvaIcons.behance,
  'battery': EvaIcons.battery,
  'bellOff': EvaIcons.bellOff,
  'barChart': EvaIcons.barChart,
  'barChart2': EvaIcons.barChart2,
  'award': EvaIcons.award,
  'backspace': EvaIcons.backspace,
  'attach': EvaIcons.attach,
  'at': EvaIcons.at,
  'attach2': EvaIcons.attach2,
  'arrowheadUp': EvaIcons.arrowheadUp,
  'arrowheadRight': EvaIcons.arrowheadRight,
  'arrowheadLeft': EvaIcons.arrowheadLeft,
  'arrowheadDown': EvaIcons.arrowheadDown,
  'arrowUpward': EvaIcons.arrowUpward,
  'arrowUp': EvaIcons.arrowUp,
  'arrowLeft': EvaIcons.arrowLeft,
  'arrowIosUpward': EvaIcons.arrowIosUpward,
  'arrowRight': EvaIcons.arrowRight,
  'arrowIosForward': EvaIcons.arrowIosForward,
  'arrowIosDownward': EvaIcons.arrowIosDownward,
  'arrowForward': EvaIcons.arrowForward,
  'arrowIosBack': EvaIcons.arrowIosBack,
  'arrowDownward': EvaIcons.arrowDownward,
  'arrowCircleUp': EvaIcons.arrowCircleUp,
  'arrowDown': EvaIcons.arrowDown,
  'arrowCircleRight': EvaIcons.arrowCircleRight,
  'arrowCircleLeft': EvaIcons.arrowCircleLeft,
  'arrowCircleDown': EvaIcons.arrowCircleDown,
  'arrowBack': EvaIcons.arrowBack,
  'archive': EvaIcons.archive,
  'alertTriangle': EvaIcons.alertTriangle,
  'alertCircle': EvaIcons.alertCircle,
  'activity': EvaIcons.activity,
  'wifiOutline': EvaIcons.wifiOutline,
  'wifiOffOutline': EvaIcons.wifiOffOutline,
  'volumeMuteOutline': EvaIcons.volumeMuteOutline,
  'volumeOffOutline': EvaIcons.volumeOffOutline,
  'volumeUpOutline': EvaIcons.volumeUpOutline,
  'volumeDownOutline': EvaIcons.volumeDownOutline,
  'videoOutline': EvaIcons.videoOutline,
  'videoOffOutline': EvaIcons.videoOffOutline,
  'uploadOutline': EvaIcons.uploadOutline,
  'unlockOutline': EvaIcons.unlockOutline,
  'undoOutline': EvaIcons.undoOutline,
  'umbrellaOutline': EvaIcons.umbrellaOutline,
  'twitterOutline': EvaIcons.twitterOutline,
  'tvOutline': EvaIcons.tvOutline,
  'trendingUpOutline': EvaIcons.trendingUpOutline,
  'trashOutline': EvaIcons.trashOutline,
  'trendingDownOutline': EvaIcons.trendingDownOutline,
  'trash2Outline': EvaIcons.trash2Outline,
  'toggleRightOutline': EvaIcons.toggleRightOutline,
  'toggleLeftOutline': EvaIcons.toggleLeftOutline,
  'thermometerOutline': EvaIcons.thermometerOutline,
  'thermometerPlusOutline': EvaIcons.thermometerPlusOutline,
  'thermometerMinusOutline': EvaIcons.thermometerMinusOutline,
  'syncOutline': EvaIcons.syncOutline,
  'textOutline': EvaIcons.textOutline,
  'swapOutline': EvaIcons.swapOutline,
  'sunOutline': EvaIcons.sunOutline,
  'stopCircleOutline': EvaIcons.stopCircleOutline,
  'squareOutline': EvaIcons.squareOutline,
  'starOutline': EvaIcons.starOutline,
  'speakerOutline': EvaIcons.speakerOutline,
  'smartphoneOutline': EvaIcons.smartphoneOutline,
  'slashOutline': EvaIcons.slashOutline,
  'skipForwardOutline': EvaIcons.skipForwardOutline,
  'shuffleOutline': EvaIcons.shuffleOutline,
  'skipBackOutline': EvaIcons.skipBackOutline,
  'shoppingCartOutline': EvaIcons.shoppingCartOutline,
  'shuffle2Outline': EvaIcons.shuffle2Outline,
  'shoppingBagOutline': EvaIcons.shoppingBagOutline,
  'shieldOffOutline': EvaIcons.shieldOffOutline,
  'shieldOutline': EvaIcons.shieldOutline,
  'shareOutline': EvaIcons.shareOutline,
  'settings2Outline': EvaIcons.settings2Outline,
  'settingsOutline': EvaIcons.settingsOutline,
  'shakeOutline': EvaIcons.shakeOutline,
  'searchOutline': EvaIcons.searchOutline,
  'scissorsOutline': EvaIcons.scissorsOutline,
  'saveOutline': EvaIcons.saveOutline,
  'rewindLeftOutline': EvaIcons.rewindLeftOutline,
  'rewindRightOutline': EvaIcons.rewindRightOutline,
  'refreshOutline': EvaIcons.refreshOutline,
  'repeatOutline': EvaIcons.repeatOutline,
  'recordingOutline': EvaIcons.recordingOutline,
  'radioOutline': EvaIcons.radioOutline,
  'radioButtonOnOutline': EvaIcons.radioButtonOnOutline,
  'radioButtonOffOutline': EvaIcons.radioButtonOffOutline,
  'questionMarkOutline': EvaIcons.questionMarkOutline,
  'questionMarkCircleOutline': EvaIcons.questionMarkCircleOutline,
  'pricetagsOutline': EvaIcons.pricetagsOutline,
  'printerOutline': EvaIcons.printerOutline,
  'plusSquareOutline': EvaIcons.plusSquareOutline,
  'powerOutline': EvaIcons.powerOutline,
  'plusCircleOutline': EvaIcons.plusCircleOutline,
  'plusOutline': EvaIcons.plusOutline,
  'playCircleOutline': EvaIcons.playCircleOutline,
  'pinOutline': EvaIcons.pinOutline,
  'pieChartOutline': EvaIcons.pieChartOutline,
  'phoneOffOutline': EvaIcons.phoneOffOutline,
  'phoneOutline': EvaIcons.phoneOutline,
  'phoneMissedOutline': EvaIcons.phoneMissedOutline,
  'phoneCallOutline': EvaIcons.phoneCallOutline,
  'personRemoveOutline': EvaIcons.personRemoveOutline,
  'personDoneOutline': EvaIcons.personDoneOutline,
  'personOutline': EvaIcons.personOutline,
  'peopleOutline': EvaIcons.peopleOutline,
  'personAddOutline': EvaIcons.personAddOutline,
  'personDeleteOutline': EvaIcons.personDeleteOutline,
  'percentOutline': EvaIcons.percentOutline,
  'pauseCircleOutline': EvaIcons.pauseCircleOutline,
  'pantoneOutline': EvaIcons.pantoneOutline,
  'paperPlaneOutline': EvaIcons.paperPlaneOutline,
  'optionsOutline': EvaIcons.optionsOutline,
  'options2Outline': EvaIcons.options2Outline,
  'navigationOutline': EvaIcons.navigationOutline,
  'npmOutline': EvaIcons.npmOutline,
  'navigation2Outline': EvaIcons.navigation2Outline,
  'musicOutline': EvaIcons.musicOutline,
  'moveOutline': EvaIcons.moveOutline,
  'moreVerticalOutline': EvaIcons.moreVerticalOutline,
  'moreHorizotnalOutline': EvaIcons.moreHorizotnalOutline,
  'moonOutline': EvaIcons.moonOutline,
  'monitorOutline': EvaIcons.monitorOutline,
  'minusSquareOutline': EvaIcons.minusSquareOutline,
  'minusOutline': EvaIcons.minusOutline,
  'minusCircleOutline': EvaIcons.minusCircleOutline,
  'minimizeOutline': EvaIcons.minimizeOutline,
  'micOutline': EvaIcons.micOutline,
  'micOffOutline': EvaIcons.micOffOutline,
  'messageSquareOutline': EvaIcons.messageSquareOutline,
  'messageCircleOutline': EvaIcons.messageCircleOutline,
  'menuOutline': EvaIcons.menuOutline,
  'menuArrowOutline': EvaIcons.menuArrowOutline,
  'menu2Outline': EvaIcons.menu2Outline,
  'maximizeOutline': EvaIcons.maximizeOutline,
  'mapOutline': EvaIcons.mapOutline,
  'logOutOutline': EvaIcons.logOutOutline,
  'logInOutline': EvaIcons.logInOutline,
  'lockOutline': EvaIcons.lockOutline,
  'loaderOutline': EvaIcons.loaderOutline,
  'listOutline': EvaIcons.listOutline,
  'linkedinOutline': EvaIcons.linkedinOutline,
  'linkOutline': EvaIcons.linkOutline,
  'link2Outline': EvaIcons.link2Outline,
  'layoutOutline': EvaIcons.layoutOutline,
  'layersOutline': EvaIcons.layersOutline,
  'keypadOutline': EvaIcons.keypadOutline,
  'infoOutline': EvaIcons.infoOutline,
  'inboxOutline': EvaIcons.inboxOutline,
  'imageOutline': EvaIcons.imageOutline,
  'homeOutline': EvaIcons.homeOutline,
  'heartOutline': EvaIcons.heartOutline,
  'headphonesOutline': EvaIcons.headphonesOutline,
  'hashOutline': EvaIcons.hashOutline,
  'hardDriveOutline': EvaIcons.hardDriveOutline,
  'gridOutline': EvaIcons.gridOutline,
  'globeOutline': EvaIcons.globeOutline,
  'googleOutline': EvaIcons.googleOutline,
  'globe2Outline': EvaIcons.globe2Outline,
  'githubOutline': EvaIcons.githubOutline,
  'giftOutline': EvaIcons.giftOutline,
  'funnelOutline': EvaIcons.funnelOutline,
  'folderRemoveOutline': EvaIcons.folderRemoveOutline,
  'folderOutline': EvaIcons.folderOutline,
  'folderAddOutline': EvaIcons.folderAddOutline,
  'flip2Outline': EvaIcons.flip2Outline,
  'flipOutline': EvaIcons.flipOutline,
  'flashOutline': EvaIcons.flashOutline,
  'flashOffOutline': EvaIcons.flashOffOutline,
  'filmOutline': EvaIcons.filmOutline,
  'flagOutline': EvaIcons.flagOutline,
  'fileTextOutline': EvaIcons.fileTextOutline,
  'fileRemoveOutline': EvaIcons.fileRemoveOutline,
  'fileOutline': EvaIcons.fileOutline,
  'fileAddOutline': EvaIcons.fileAddOutline,
  'facebookOutline': EvaIcons.facebookOutline,
  'eyeOutline': EvaIcons.eyeOutline,
  'eyeOffOutline': EvaIcons.eyeOffOutline,
  'eyeOff2Outline': EvaIcons.eyeOff2Outline,
  'externalLinkOutline': EvaIcons.externalLinkOutline,
  'expandOutline': EvaIcons.expandOutline,
  'emailOutline': EvaIcons.emailOutline,
  'editOutline': EvaIcons.editOutline,
  'edit2Outline': EvaIcons.edit2Outline,
  'dropletOutline': EvaIcons.dropletOutline,
  'dropletOffOutline': EvaIcons.dropletOffOutline,
  'downloadOutline': EvaIcons.downloadOutline,
  'doneAllOutline': EvaIcons.doneAllOutline,
  'diagonalArrowRightUpOutline': EvaIcons.diagonalArrowRightUpOutline,
  'diagonalArrowLeftUpOutline': EvaIcons.diagonalArrowLeftUpOutline,
  'diagonalArrowRightDownOutline': EvaIcons.diagonalArrowRightDownOutline,
  'diagonalArrowLeftDownOutline': EvaIcons.diagonalArrowLeftDownOutline,
  'cubeOutline': EvaIcons.cubeOutline,
  'cropOutline': EvaIcons.cropOutline,
  'creditCardOutline': EvaIcons.creditCardOutline,
  'cornerUpRightOutline': EvaIcons.cornerUpRightOutline,
  'cornerRightUpOutline': EvaIcons.cornerRightUpOutline,
  'cornerUpLeftOutline': EvaIcons.cornerUpLeftOutline,
  'cornerRightDownOutline': EvaIcons.cornerRightDownOutline,
  'cornerLeftUpOutline': EvaIcons.cornerLeftUpOutline,
  'cornerLeftDownOutline': EvaIcons.cornerLeftDownOutline,
  'cornerDownLeftOutline': EvaIcons.cornerDownLeftOutline,
  'cornerDownRightOutline': EvaIcons.cornerDownRightOutline,
  'copyOutline': EvaIcons.copyOutline,
  'compassOutline': EvaIcons.compassOutline,
  'colorPickerOutline': EvaIcons.colorPickerOutline,
  'colorPaletteOutline': EvaIcons.colorPaletteOutline,
  'collapseOutline': EvaIcons.collapseOutline,
  'codeOutline': EvaIcons.codeOutline,
  'codeDownloadOutline': EvaIcons.codeDownloadOutline,
  'cloudUploadOutline': EvaIcons.cloudUploadOutline,
  'cloudDownloadOutline': EvaIcons.cloudDownloadOutline,
  'closeSquareOutline': EvaIcons.closeSquareOutline,
  'closeOutline': EvaIcons.closeOutline,
  'closeCircleOutline': EvaIcons.closeCircleOutline,
  'clockOutline': EvaIcons.clockOutline,
  'clipboardOutline': EvaIcons.clipboardOutline,
  'chevronUpOutline': EvaIcons.chevronUpOutline,
  'chevronRightOutline': EvaIcons.chevronRightOutline,
  'chevronLeftOutline': EvaIcons.chevronLeftOutline,
  'chevronDownOutline': EvaIcons.chevronDownOutline,
  'checkmarkSquareOutline': EvaIcons.checkmarkSquareOutline,
  'checkmarkSquare2Outline': EvaIcons.checkmarkSquare2Outline,
  'checkmarkOutline': EvaIcons.checkmarkOutline,
  'checkmarkCircleOutline': EvaIcons.checkmarkCircleOutline,
  'checkmarkCircle2Outline': EvaIcons.checkmarkCircle2Outline,
  'chargingOutline': EvaIcons.chargingOutline,
  'castOutline': EvaIcons.castOutline,
  'carOutline': EvaIcons.carOutline,
  'cameraOutline': EvaIcons.cameraOutline,
  'calendarOutline': EvaIcons.calendarOutline,
  'bulbOutline': EvaIcons.bulbOutline,
  'browserOutline': EvaIcons.browserOutline,
  'brushOutline': EvaIcons.brushOutline,
  'briefcaseOutline': EvaIcons.briefcaseOutline,
  'bookmarkOutline': EvaIcons.bookmarkOutline,
  'bookOutline': EvaIcons.bookOutline,
  'bookOpenOutline': EvaIcons.bookOpenOutline,
  'bluetoothOutline': EvaIcons.bluetoothOutline,
  'bellOutline': EvaIcons.bellOutline,
  'bellOffOutline': EvaIcons.bellOffOutline,
  'behanceOutline': EvaIcons.behanceOutline,
  'batteryOutline': EvaIcons.batteryOutline,
  'barChartOutline': EvaIcons.barChartOutline,
  'barChart2Outline': EvaIcons.barChart2Outline,
  'backspaceOutline': EvaIcons.backspaceOutline,
  'awardOutline': EvaIcons.awardOutline,
  'attachOutline': EvaIcons.attachOutline,
  'attach2Outline': EvaIcons.attach2Outline,
  'atOutline': EvaIcons.atOutline,
  'arrowheadUpOutline': EvaIcons.arrowheadUpOutline,
  'arrowheadRightOutline': EvaIcons.arrowheadRightOutline,
  'arrowheadLeftOutline': EvaIcons.arrowheadLeftOutline,
  'arrowheadDownOutline': EvaIcons.arrowheadDownOutline,
  'arrowUpwardOutline': EvaIcons.arrowUpwardOutline,
  'arrowUpOutline': EvaIcons.arrowUpOutline,
  'arrowRightOutline': EvaIcons.arrowRightOutline,
  'arrowLeftOutline': EvaIcons.arrowLeftOutline,
  'arrowIosUpwardOutline': EvaIcons.arrowIosUpwardOutline,
  'arrowIosForwardOutline': EvaIcons.arrowIosForwardOutline,
  'arrowIosDownwardOutline': EvaIcons.arrowIosDownwardOutline,
  'arrowIosBackOutline': EvaIcons.arrowIosBackOutline,
  'arrowForwardOutline': EvaIcons.arrowForwardOutline,
  'arrowDownwardOutline': EvaIcons.arrowDownwardOutline,
  'arrowDownOutline': EvaIcons.arrowDownOutline,
  'arrowCircleUpOutline': EvaIcons.arrowCircleUpOutline,
  'arrowCircleRightOutline': EvaIcons.arrowCircleRightOutline,
  'arrowCircleLeftOutline': EvaIcons.arrowCircleLeftOutline,
  'arrowBackOutline': EvaIcons.arrowBackOutline,
  'arrowCircleDownOutline': EvaIcons.arrowCircleDownOutline,
  'archiveOutline': EvaIcons.archiveOutline,
  'alertTriangleOutline': EvaIcons.alertTriangleOutline,
  'alertCircleOutline': EvaIcons.alertCircleOutline,
  'activityOutline': EvaIcons.activityOutline,
};
